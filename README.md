...
- **v2026.06.16** - 修复 DashScope 云端 ASR 实时识别无输出和发送后重复显示问题；WebSocket 替换为标准 ws 库解决中文乱码；新增热词管理（AI 自动提取、6 个预设模板、统一本地/云端配置）；新增知识库管理（文档上传、AI 回答模块一键选择资料）；支持 Fun-ASR/Qwen-ASR/Paraformer 三种云端模型
